...
- Name: basic-interactions.spec.ts >> Basic Interactions (E2E) >> should have webview container for tabs
- Location: tests\e2e\basic-interactions.spec.ts:109:7
...
Locator: locator('.webview-container')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.webview-container')
